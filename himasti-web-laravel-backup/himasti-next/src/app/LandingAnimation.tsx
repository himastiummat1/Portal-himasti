    ...
    >
      ...
      <section className="relative w-full min-h-[90dvh] flex flex-col items-center justify-center text-center px-4 sm:px-6 pt-36 pb-16 max-w-5xl mx-auto gap-8">
        ...
        <div className="flex flex-col items-center justify-center z-10 w-full">
          ...
          {/* Animated Announcement Shimmer Badge */}
          <motion.div 
          ...
          >
            ...
            >
              ...
              <span className="text-blue-400 group-hover:translate-x-0.5 transition-transform text-[11px]">→</span>
            </Link>
          </motion.div>
      ...
      <footer className="w-full py-12 px-6 bg-white border-t border-slate-200/80 text-slate-500 text-xs">
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center justify-between gap-5">
          <div className="flex items-center gap-2.5">
            <img src="/images/logo_himasti.jpg" alt="Logo HIMASTI" className="w-6 h-6 object-contain rounded-full border border-slate-200 shadow-xs" />
            <span className="font-bold text-slate-800">HIMASTI UMMAT</span>
