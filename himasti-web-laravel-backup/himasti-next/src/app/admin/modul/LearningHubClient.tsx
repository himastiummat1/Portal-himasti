...
export default function LearningHubClient({ userName }: { userName: string }) {
  ...
  const roadmaps = [
    {
      ...
      icon: <Layout className="w-8 h-8 text-gray-900" />,
    ...
    },
    {
      ...
      icon: <Server className="w-8 h-8 text-gray-900" />,
    ...
    },
    {
      ...
      icon: <Cpu className="w-8 h-8 text-gray-900" />,
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-8 animate-in fade-in duration-500 pb-12">
      ...
      {activeTab === "roadmap" && (
        <div className="space-y-6 animate-in slide-in-from-bottom-4 duration-300">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-4 gap-6">
            {roadmaps.map((road) => (
              <div key={road.id} className="bg-white border border-slate-200 rounded-3xl p-6 shadow-sm hover:border-gray-300 hover:shadow-md transition-all flex flex-col group">
                <div className="w-16 h-16 bg-slate-50 border border-slate-100 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 group-hover:bg-gray-50 transition-transform">
                  {road.icon}
                </div>
                ...
                <a href={road.link} target="_blank" className="mt-8 w-full py-3 bg-gray-900 hover:bg-gray-800 text-white rounded-xl text-sm font-semibold transition-colors shadow-sm flex justify-center items-center gap-2">
        ...
        <div className="space-y-6 animate-in slide-in-from-bottom-4 duration-300">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
            ...
            <div className="relative w-full sm:w-64">
              ...
              <input type="text" placeholder="Cari mata kuliah..." className="w-full bg-white border border-slate-200 rounded-xl pl-9 pr-4 py-2 text-sm focus:outline-none focus:border-gray-900 focus:ring-1 focus:ring-gray-900 transition-all" />
            </div>
          </div>
              ...
              <div key={idx} className="bg-white border border-slate-200 rounded-2xl overflow-hidden shadow-sm">
                ...
                <div className="divide-y divide-slate-100">
                  {smt.courses.map((course, i) => (
                    <div key={i} className="flex justify-between items-center p-4 hover:bg-gray-50/30 transition-colors group">
                      ...
                      <button className="text-slate-400 hover:text-gray-900 p-2 rounded-lg hover:bg-gray-50 transition-colors">
            ...
            {cheatsheets.map((cheat, idx) => (
              <div key={idx} className="bg-slate-900 rounded-2xl overflow-hidden shadow-lg border border-slate-800 flex flex-col">
                <div className="flex justify-between items-center px-4 py-3 bg-slate-950 border-b border-slate-800">
                  ...
                  <span className="text-[10px] font-mono text-sky-400 uppercase tracking-wider bg-gray-100/50 px-2 py-0.5 rounded-full">
                    {cheat.lang}
                  </span>
                </div>
      ...
      {activeTab === "vidyax" && (
        <div className="space-y-6 animate-in slide-in-from-bottom-4 duration-300">
          <div className="bg-gray-50 from-slate-900 to-black rounded-3xl p-8 md:p-12 text-white shadow-2xl relative overflow-hidden border border-slate-800">
            ...
            <div className="relative z-10 flex flex-col md:flex-row gap-12 items-center">
              <div className="flex-1 space-y-6">
                ...
                <h2 className="text-4xl md:text-5xl font-bold tracking-tight bg-gray-50 from-white to-slate-400 bg-clip-text text-transparent">
                  Vidyax
                </h2>
              ...
              <div className="flex-1 w-full">
                <div className="bg-slate-950/80 rounded-2xl overflow-hidden border border-slate-800 shadow-2xl backdrop-blur-md">
                  ...
                  <div className="p-5 text-sm font-mono text-slate-300 leading-loose overflow-x-auto whitespace-pre-wrap break-words">
                    <span className="text-gray-400">use</span> ai<br/><br/>
                    ...
                    <span className="text-gray-400">agent</span> s1:<br/>
